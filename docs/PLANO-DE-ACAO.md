...
| **E4.4** | Deploy | ✅ compose de produção com portas internas fechadas, painel com senha no nginx e túnel Cloudflare para HTTPS estável. [D-111](DECISOES.md) · [GUIA-DEPLOY.md](GUIA-DEPLOY.md) |
